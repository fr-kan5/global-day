...
⑥ コメントから得た学びや他者の投稿から得た学びを「My memo」へコピペして管理することができる
 　右上アバター写真をクリック → 「My memo」を選択
  ...
  ![how_to_memo](https://user-images.githubusercontent.com/71579504/99179244-202b0a00-275f-11eb-91c8-957aabace28a.gif)
...
# ✅ 課題解決
1(ユーザーストーリーから考える課題)
　(１)日常会話はある程度できていても文法があっているのかわからないという日常の課題
　(２)新しい単語を覚えても使い方が合っているのかわからないという課題
　(３)TwitterやInstagramへアウトプットのために活用しても目的の一致した人と関わりづらいという課題
　(４)語学学校に行ってたくさんの国籍の人と関わりたいと思っているがコロナ化であることと仕事の関係上難しいという課題
　(５)語学勉強のためのアプリケーションはたくさんあるが、有料のものが多い
　(６)アウトプットの仕方がわからないという課題

２(課題解決)

　(１)日記は語学のアウトプットに良いとされているため、SNSの仕組みで気軽に投稿できるものとする
　(２)コメント機能をつけ各自のアウトプットのため投稿へ助言ができるようにする
　(３)語学を学ぶことに特化するSNSとすることで同じ目的の人同士が関わることができるようにする
　(４)自分の苦手箇所や単語の使い方を復習できるよう個人のメモ機能をマイページとして使用できるようにする
　(５)同じ目的を持つ人たちによる勉強型SNSにすることで無料のアプリケーションとすることができる
　
...
　(１)　画像が表示されている
　(２)　上から更新日時の新しい順で表示されること
　(３)　画像・ユーザーネーム・出身国・投稿内容が表示される
　(４)　ログアウト状態のユーザーは閲覧できない
　　　-URLで遷移しようとしてもログイン画面へ移動する

## 投稿機能

　(１)　タイトル・内容・画像・撮影場所の記述
　　　-　タイトル・内容・画像・場所の記述は必須
　(２)　ログイン状態のユーザーだけが、投稿できる
　　　-　ログアウト状態のユーザーはログイン画面へ遷移する
　(３)　投稿完了後は一覧画面へ遷移する

## 投稿詳細機能

　(１)　一覧画面から特定の投稿をクリックすると投稿詳細ページへ遷移する
　(２)　投稿タイトル・画像・内容・ユーザーネームを表示
　(３)　ログアウト状態のユーザーは閲覧できない
　　　-　URLで遷移しようとしてもログイン画面へ移動する
